...
var createMessageType = (function() {
  ...
  var MessageBase = (function() {
    ...
    Base.prototype._ensureLength = function(array, len) {
      if (typeof array.BYTES_PER_ELEMENT == 'undefined') {
        console.trace();
      ...
      if (array.buffer.byteLength < len * array.BYTES_PER_ELEMENT) {
        var newLen = Math.max(array.buffer.byteLength * 2,
                              len * array.BYTES_PER_ELEMENT);
